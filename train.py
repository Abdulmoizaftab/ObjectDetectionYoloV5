...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    is_coco = isinstance(val_path, str) and val_path.endswith('coco2/val2017.txt')  # COCO dataset
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco2.yaml', help='dataset.yaml path')
